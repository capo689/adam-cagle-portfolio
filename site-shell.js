...
(function () {
  const NAV = [
    ...
    { key: 'ai-writing',       href: '/AISystems.html',       label: 'AI Systems'      },
    { key: 'writing-samples',  href: '/WritingSamples.html',  label: 'Writing Samples' },
...
'<header class="rail" data-active="' + active + '">' +
  '<a href="/" class="rail-brand" data-cursor="hover">Adam R. Cagle</a>' +
  ...
  '<div class="foot-inner">' +
    ...
    '<div class="foot-top">' +
      ...
      '<div class="foot-col foot-col--brand">' +
        '<a href="/" class="foot-wordmark">Adam R. Cagle</a>' +
      ...
      '<div class="foot-col foot-col--nav">' +
        ...
        '<nav class="foot-nav-links">' +
          ...
          '<a href="/AISystems.html">AI Systems</a>' +
      ...
      '<div class="foot-col foot-col--contact">' +
        ...
        '<a href="' + LINKEDIN + '" class="foot-li-btn" target="_blank" rel="noopener">' +
          ...
          '<span>LinkedIn</span>' +
        '</a>' +
        '<a href="/Contact.html" class="foot-contact-link">Contact page &nbsp;&rarr;</a>' +
      '</div>' +
