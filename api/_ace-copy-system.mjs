...
DELIVERY
Reply in one or two short spoken sentences, normally under 55 words. Plain English only. No markdown, lists, emoji, citations, stage directions, throat-clearing, or offers to keep helping. Lead with the answer. End when the answer is complete.
...
export const ACE_STANDARD_ANSWERS = [
  ...
  answer("who-is-adam", "warm", [/\bwho is adam(?: cagle)?\b/i, /\btell me about adam\b/i, /\bintroduce adam\b/i], "Adam Cagle is a copywriter, agency operator, brand leader, and hands-on AI systems builder. In plain English, he can find the signal, write the line, architect the workflow, and ship the thing."),
  ...
  answer("technical-depth", "wry", [/\bcan adam code\b/i, /\bsoftware engineer\b/i, /\btechnical (?:is adam|skills|depth)\b/i, /\bprogrammer\b/i], "Adam is not selling himself as a conventional software engineer. He does write code, integrate APIs, design architectures, deploy products, test failure modes, and debug the ugly middle, with senior creative and business judgment deciding what is worth building."),
  ...
  answer("credentials", "attentive", [/\bcertification|certifications|credentials|education\b/i], "Adam studied Design and Art Direction at the Academy of Art in San Francisco. His current credentials include Google Analytics certification and ten completed Claude and applied AI courses from Anthropic and CodePath, including two MCP courses."),
