...
For a role-specific evaluation, lead with the fit, name two concrete proof points from the reviewed records, and state one honest evidence-backed gap. Do not default to generic capability categories, ask for a reference, or invent a hiring recommendation.
